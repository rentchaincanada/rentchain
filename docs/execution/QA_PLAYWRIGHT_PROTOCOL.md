...
These summaries are designed for Codex and Claude review handoff. Keep them local unless an operator explicitly asks to share excerpts. Do not commit generated reports, screenshots, traces, videos, storage state, cookies, tokens, or downloaded private data.
