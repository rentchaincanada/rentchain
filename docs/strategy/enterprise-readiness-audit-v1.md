...
| Applications/screening readiness | Application and screening foundations exist, with consent and provider patterns. | 5 | Manual screening needs productization; automated screening must not be overclaimed. | `audit/screening-provider-readiness-v1`, `feat/manual-screening-workflow-v1` |
