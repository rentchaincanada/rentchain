...
export async function fetchLandlordActionRecommendations(): Promise<{
  recommendations: LandlordActionRecommendationV1[];
}> {
  return await apiFetch<{ recommendations: LandlordActionRecommendationV1[] }>(
    "/landlord/action-recommendations"
  );
}
