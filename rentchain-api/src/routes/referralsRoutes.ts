    ...
    if (apiKey && from) {
      try {
        ...
        await sendEmail({
          ...
          text: buildEmailText({
            intro: `${inviter} invited you to RentChain.`,
            bullets: [
              "Verified screening",
            ...
            ctaUrl: link,
            footerNote: "If you didn't request this invite, you can safely ignore this email.",
          }),
          html: buildEmailHtml({
            title: "You're invited to RentChain",
            preheader: "A landlord invited you to RentChain - verified screening and clear rental records.",
            intro: `${inviter} invited you to RentChain.`,
            bullets: [
              "Verified screening",
              "Clear rental records",
