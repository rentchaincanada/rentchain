      ...
      if (normalizedUnits.length > 0) {
        ...
        for (const unit of normalizedUnits) {
          ...
          batch.set(unitRef, {
            ...
            occupancyStatus: unit.status || "vacant",
            occupantName: unit.status === "occupied" ? (unit as any).occupantName || null : null,
            tenantName: unit.status === "occupied" ? (unit as any).occupantName || null : null,
            leaseEndDate: unit.status === "occupied" ? (unit as any).leaseEndDate || null : null,
            createdAt: now,
            updatedAt: now,
