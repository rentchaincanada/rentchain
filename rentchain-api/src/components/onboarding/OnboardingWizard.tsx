    ...
    >
      ...
      >
        ...
        >
          ...
          {stepIndex === 1 && (
            <StepProperty onLaunchAddProperty={onLaunchAddProperty} />
          )}
          ...
          >
            <button
              ...
              style={{
                ...
                padding: "4px 10px",
                backgroundColor: "transparent",
                color: stepIndex === 0 ? "#4b5563" : "#e5e7eb",
                fontSize: 11,
...
const StepPlanSelection: React.FC<StepPlanSelectionProps> = ({
  ...
  return (
    <div>
      ...
      >
        In demo mode, this doesn&apos;t bill you. It just changes which features
        are active so you can see what each plan unlocks.
      </div>
      <div
        style={{
          display: "grid",
