...
import adminRecoveryRoutes from "./routes/adminRecoveryRoutes";
...
import landlordOnboardingHardeningRoutes from "./routes/landlordOnboardingHardeningRoutes";
...
app.use("/api/admin", routeSource("adminRecoveryRoutes.ts"), adminRecoveryRoutes);
console.log("[route-mount] adminRecoveryRoutes mounted at /api/admin");
...
app.use("/api/landlord/evidence-packages", rateLimitEvidenceExportReview);
app.use("/api/landlord", routeSource("landlordEvidencePackageGenerationRoutes.ts"), landlordEvidencePackageGenerationRoutes);
console.log("[route-mount] landlordEvidencePackageGenerationRoutes mounted at /api/landlord");
...
app.use("/api/landlord", routeSource("landlordOnboardingHardeningRoutes.ts"), landlordOnboardingHardeningRoutes);
console.log("[route-mount] landlordOnboardingHardeningRoutes mounted at /api/landlord");
