...
app.use("/api", routeSource("leaseNoticeLandlordRoutes.ts"), leaseNoticeLandlordRoutes);
app.use("/api", routeSource("tenantLeaseNoticeRoutes.ts"), tenantLeaseNoticeRoutes);
