...
export function aggregateOccupancyReviewWorkspace(landlordId: string, records: OccupancyReviewRecords): OccupancyReviewWorkspace {
  ...
  for (const tenant of tenants.values()) {
    ...
    const remediation = classifyStaleTenantRelationship({ landlordId, tenantId, records: { tenant, leases, tenancies, units, properties: [...properties.values()], canonicalEvents: records.canonicalEvents || [] } });
