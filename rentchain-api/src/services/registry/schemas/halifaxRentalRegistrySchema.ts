  ...
  buildExportPayload: ({ property, submission }) => ({
    ...
    sections: {
      propertySite: {
        ...
        moreThanFiveBuildings: submission.fieldValues.moreThanFiveBuildings,
      },
      propertyOwner: submission.fieldValues.owner,
      primaryContact:
      ...
      buildings: submission.fieldValues.buildings.map((building) => ({
        ...
        alternateContact: building.hasAlternateContact === true ? building.alternateContact : { sameAsOwner: true },
