...
This repository includes an optional dev container for QA infrastructure work. It pins Node 24.19.0, installs Playwright 1.58.2, and forwards the frontend and API development ports.
