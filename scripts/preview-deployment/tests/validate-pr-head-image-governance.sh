...
check "critical build files must match trusted main" contains "${workflow}" 'git diff --quiet "${WORKFLOW_SHA}" "${SOURCE_SHA}" -- rentchain-api/Dockerfile rentchain-api/package.json rentchain-api/package-lock.json'
